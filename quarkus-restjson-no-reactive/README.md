...
- Camel AWS 2 Elastic Kubernetes Service (EKS) ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/aws2-eks.html)): Manage AWS EKS cluster instances using AWS SDK version 2.x
